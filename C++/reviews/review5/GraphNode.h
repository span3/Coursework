...
// Changes color from int value to enum color
	...
	// Generates 2 identical matrices with set edges and colors.
		// The matrix shows the distance and color of edges
		// as shown:
		//          1   2       Creates two identical matrices with edge sets and colors.
		//        _________     The cells generated by the matrix represent the distance
		//    1   | 7 | 5 |     from one cell to another. For example, this small 2*2 matrix
		//        |---|---|     has cell (1,2), which shows the same distance as cell (2,1).
		//    2   | 5 | 7 |
		//        |---|---|
