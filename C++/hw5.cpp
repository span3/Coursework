// For this program, I learned about Monte Carlo and the alpha beta pruning, and how they can be
// used to create an effective and intelligent AI.  I was unable to get my Monte Carlo working,
// though I'm fairly confident that it was just a problem of coding errors.  This assignment also 
// taught me that if I had organized my classes better with pointers and separate headers, I might
// not have run into as many problems.  Since the previous assignments required more basic use
// of the graph and node classes, I ended up never setting them up properly, and this ended up
// coming back to bite me for this assignment.  Overall though, I think I understood Monte Carlo
// and used it correctly.

// To compile: g++ -o hw5 hw5.cpp
// To run: hw5
...
//The computer makes a move based on Monte Carlo.
void computerTurn(Graph* graph, int firstTurn, int turnCounter) {
  ...
  for (;;) {
    //If a valid move can be made here, run 100 simulations of random moves and see how many are victories.
  ...
  //Check for the move that had the most victories and have the computer move there.
