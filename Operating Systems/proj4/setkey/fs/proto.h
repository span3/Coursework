...
_PROTOTYPE( int dev_close, (Dev_t dev)                      );
...
_PROTOTYPE( void dmap_unmap_by_endpy, (int proc_nr)                 );
...
_PROTOTYPE( int select_notificed, (int major, int minor, int ops)       );

/* timers.c */
_PROTOTYPE( void fs_set_timer, (timer_t *tp, int delta, tmr_funct_t watchdog, 
                                 int arg));
